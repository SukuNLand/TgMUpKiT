...
try:
    ...
    class ExecVars:
        ...
        EDIT_SLEEP_SECS = int(os.environ.get("EDIT_SLEEP_TIME_OUT", 20))
        ...
        MAX_YTPLAYLIST_SIZE = int(os.environ.get("MAX_YTPLAYLIST_SIZE", "100"))
        
        # Max size of the torrent allowed
        MAX_TORRENT_SIZE = int(os.environ.get("MAX_TORRENT_SIZE", "400"))

        # Set this to your bot username if you want to add the username of your bot at the end of the commands like
        BOT_CMD_POSTFIX = os.environ.get("BOT_CMD_POSTFIX", "")  

        # Time out for the status Delete.
        STATUS_DEL_TOUT = int(os.environ.get("STATUS_DEL_TOUT", "120"))
        ...
        TOR_MAX_TOUT = int(os.environ.get("TOR_MAX_TOUT", "1800"))
        ...
        FORCE_DOCS_USER = os.environ.get("FORCE_DOCS_USER", "True") 
        FAST_UPLOAD = os.environ.get("FAST_UPLOAD", "True") 
        METAINFO_BOT = os.environ.get("METAINFO_BOT", "False") 
